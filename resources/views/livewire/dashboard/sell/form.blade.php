<div class="transaksi-form">
    ...
    <x-form>
        ...
        <x-input type="select" label="ID Customer" wire="customer" :options="$customers" placeholder=" " :required="true" />
    ...
    {{-- Buttons --}}
    <div class="buttons">
        <a href="{{ route('dashboard.sell.index') }}" class="button transparent">Cancel</a>
